...
const (
	TelegramBotToken = "здесть токен тг бота"                                                                                                                                                                                                                                                                                                                                       // Токен вашего Telegram бота
	OpenRouterAPIURL = "здесь ссылка на api версии"                                                                                                                                                                                                                                                                                                                                        // URL API OpenRouter
